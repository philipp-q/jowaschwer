...
from tequila.hamiltonian import HamiltonianQC, QubitHamiltonian, paulis
...
class QuantumChemistryBase:
    ...
    def make_excitation_generator(self,
                                  ...
                                  gaussianize: typing.Union[bool, str] = False) -> QubitHamiltonian:
        """
        Notes
        ----------
        ...
        gaussianize: Union[bool, string] (Default Value = False) :
            Gaussianize the excitation operators on the fermionic level
            can happen in projector or involution form
            if False (Default): No gaussianization happens
            if "PROJECTOR": Gaussianization as projector
            Anyting else: Gaussianization as involution
        Returns
        -------
        type
        ...
        if gaussianize:
            ...
            if hasattr(gaussianize, "upper") and gaussianize.upper() == "PROJECTOR":
                op *= 0.5
        ...
        for key, t in amplitudes.items():
            ...
            if not numpy.isclose(t, 0.0, atol=threshold):
                ...
                if closed_shell:
                    ...
                    generators.append(self.make_excitation_generator(indices=indices))
                    if parametrized:
